...
import { parseDocs } from '@/application/Application/Loader/Collections/Compiler/Executable/DocumentationParser';
...
describe('DocumentationParser', () => {
  describe('parseDocs', () => {
    ...
    it('returns single item when string', () => {
      // arrange
      const url = 'https://anonseclab.org';
      const expected = [url];
    ...
    it('returns all when array', () => {
      // arrange
      const expected = ['https://anonseclab.org', 'https://github.com/BlueCtx/anonseclab-privacy'];
