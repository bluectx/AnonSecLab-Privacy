...
AnonSecLab Privacy Tools is a data-driven application that reads YAML files.
...
- Functions are templates compiled by AnonSecLab Privacy Tools and uses special expression expressions.
