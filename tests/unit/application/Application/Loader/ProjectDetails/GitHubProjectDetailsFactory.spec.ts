...
describe('GitHubProjectDetailsFactory', () => {
  describe('retrieval of property values', () => {
    ...
    const propertyTestScenarios: {
      ...
      feedbackUrl: [{
        description: 'without `.git` suffix',
        expectedValue: 'https://github.com/BlueCtx/anonseclab-privacy/issues',
        prepareParams: (params) => params
          .withRepositoryUrl('https://github.com/BlueCtx/anonseclab-privacy'),
        getActualValue: (sut) => sut.feedbackUrl,
      }, {
        description: 'with `.git` suffix',
        expectedValue: 'https://github.com/BlueCtx/anonseclab-privacy/issues',
        prepareParams: (params) => params
          .withRepositoryUrl('https://github.com/BlueCtx/anonseclab-privacy.git'),
        getActualValue: (sut) => sut.feedbackUrl,
      }],
      releaseUrl: [{
        description: 'without `.git` suffix',
        expectedValue: 'https://github.com/BlueCtx/anonseclab-privacy/releases/tag/0.7.2',
        prepareParams: (params) => params
          .withRepositoryUrl('https://github.com/BlueCtx/anonseclab-privacy')
  ...
  describe('correct retrieval of download URL for every supported operating system', () => {
    const testScenarios: Record<SupportedOperatingSystem, {
      ...
      [OperatingSystem.macOS]: {
        expected: 'https://github.com/BlueCtx/anonseclab-privacy/releases/download/0.7.2/anonseclab-privacy-0.7.2.dmg',
        repositoryUrl: 'https://github.com/BlueCtx/anonseclab-privacy.git',
        version: '0.7.2',
      },
      [OperatingSystem.Linux]: {
        expected: 'https://github.com/BlueCtx/anonseclab-privacy/releases/download/0.7.2/anonseclab-privacy-0.7.2.AppImage',
        repositoryUrl: 'https://github.com/BlueCtx/anonseclab-privacy.git',
        version: '0.7.2',
      },
      [OperatingSystem.Windows]: {
        expected: 'https://github.com/BlueCtx/anonseclab-privacy/releases/download/0.7.2/anonseclab-privacy-Setup-0.7.2.exe',
        repositoryUrl: 'https://github.com/BlueCtx/anonseclab-privacy.git',
        version: '0.7.2',
      },
    };
