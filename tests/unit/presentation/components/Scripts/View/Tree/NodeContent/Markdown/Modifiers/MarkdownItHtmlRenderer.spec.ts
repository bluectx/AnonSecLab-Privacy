    ...
    describe('sets default anchor attributes', () => {
      const testScenarios: ReadonlyArray<{
      ...
      }> = [
        {
          ...
          markdownWithNonCompliantAnchorAttributes: '[URL](https://anonseclab.org){ target="_self" }',
        },
        {
          attributeName: 'rel',
          expectedValue: 'noopener noreferrer',
          markdownWithNonCompliantAnchorAttributes: '[URL](https://anonseclab.org){ rel="nooverride" }',
        },
      ];
      testScenarios.forEach(({
        ...
        it(`adds "${attributeName}" attribute to anchors`, () => {
          // arrange
          const markdown = '[anonseclab.org](https://anonseclab.org)';
